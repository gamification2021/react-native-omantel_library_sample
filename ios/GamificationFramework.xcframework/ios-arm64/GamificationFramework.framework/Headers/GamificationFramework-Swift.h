...
#ifndef GAMIFICATIONFRAMEWORK_SWIFT_H
#define GAMIFICATIONFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GamificationFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21GamificationFramework15AnimatedControl")
...
SWIFT_CLASS("_TtC21GamificationFramework14AnimatedButton")
...
SWIFT_CLASS("_TtC21GamificationFramework14AnimatedSwitch")
...
SWIFT_CLASS("_TtC21GamificationFramework16AnimationSubview")
...
SWIFT_CLASS("_TtC21GamificationFramework10LottieView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC21GamificationFramework13AnimationView")
...
SWIFT_CLASS("_TtC21GamificationFramework19CompatibleAnimation")
...
SWIFT_CLASS("_TtC21GamificationFramework26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC21GamificationFramework23CompatibleAnimationView")
...
SWIFT_CLASS("_TtC21GamificationFramework17FortuneWheelLayer")
...
SWIFT_CLASS("_TtC21GamificationFramework15IQBarButtonItem")
...
SWIFT_CLASS("_TtC21GamificationFramework28IQBarButtonItemConfiguration")
...
SWIFT_CLASS("_TtC21GamificationFramework12IQInvocation")
...
SWIFT_CLASS("_TtC21GamificationFramework17IQKeyboardManager")
...
@interface IQKeyboardManager (SWIFT_EXTENSION(GamificationFramework)) <UIGestureRecognizerDelegate>
...
@interface IQKeyboardManager (SWIFT_EXTENSION(GamificationFramework))
...
SWIFT_CLASS("_TtC21GamificationFramework26IQKeyboardReturnKeyHandler")
...
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(GamificationFramework)) <UITextFieldDelegate>
...
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(GamificationFramework)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC21GamificationFramework18IQPreviousNextView")
...
SWIFT_CLASS("_TtC21GamificationFramework10IQTextView")
...
SWIFT_CLASS("_TtC21GamificationFramework20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC21GamificationFramework9IQToolbar")
...
SWIFT_CLASS("_TtC21GamificationFramework14TTFortuneWheel")
@interface TTFortuneWheel : UIControl <CAAnimationDelegate>
- (void)layoutSubviews;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface UIImage (SWIFT_EXTENSION(GamificationFramework))
...
@interface UINavigationController (SWIFT_EXTENSION(GamificationFramework))
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@end


@interface UIScrollView (SWIFT_EXTENSION(GamificationFramework))
...
@interface UIView (SWIFT_EXTENSION(GamificationFramework))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
...
@interface UIViewController (SWIFT_EXTENSION(GamificationFramework))
